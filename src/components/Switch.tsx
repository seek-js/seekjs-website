...
const switchVariants = tv({
  slots: {
    root: [
      ...
      // ring color
      "ring-zinc-950/5 dark:ring-zinc-800",
      // checked
      "data-[state=checked]:bg-zinc-600 data-[state=checked]:dark:bg-zinc-500",
      // disabled
      "data-[disabled]:cursor-default",
      // disabled checked
      "data-[disabled]:data-[state=checked]:bg-zinc-300",
      "data-[disabled]:data-[state=checked]:ring-gray-300",
      // disabled checked dark
      "data-[disabled]:data-[state=checked]:dark:ring-zinc-900",
      "data-[disabled]:data-[state=checked]:dark:bg-zinc-800",
      // disabled unchecked
