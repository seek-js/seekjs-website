    ...
    >
      <div
        className={cx(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-zinc-200 group-data-[state=checked]:text-zinc-900 dark:group-data-[state=checked]:bg-zinc-600/40 dark:group-data-[state=checked]:text-zinc-100",
          // focus
          focusRing,
        )}
      >
