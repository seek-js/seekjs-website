  ...
  variants: {
    variant: {
      primary: [
        ...
        "disabled:shadow-none disabled:filter-none",
      ],
      secondary: [
        // border
      ...
      light: [
        ...
        // hover color
        "hover:bg-gray-300/70 dark:hover:bg-zinc-800/80",
        // disabled
        "disabled:bg-gray-100 disabled:text-gray-400",
        "disabled:dark:bg-zinc-800 disabled:dark:text-gray-600",
      ],
      ghost: [
        // base
        "shadow-none",
        ...
        "text-zinc-950 dark:text-gray-50",
        // hover color
        "bg-transparent hover:bg-gray-100 dark:hover:bg-zinc-800/80",
        // disabled
        "disabled:text-gray-400",
        "disabled:dark:text-gray-600",
      ],
