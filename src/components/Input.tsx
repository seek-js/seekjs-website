...
const inputStyles = tv({
  base: [
    ...
    "disabled:dark:border-gray-700 disabled:dark:bg-zinc-800 disabled:dark:text-gray-500",
    // file
    [
      ...
      "file:border-solid file:border-gray-300 file:bg-gray-50 file:text-gray-500 file:hover:bg-gray-100 file:dark:border-gray-800 file:dark:bg-zinc-950 file:hover:dark:bg-zinc-900/20 file:disabled:dark:border-gray-700",
      "file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]",
      "file:disabled:bg-gray-100 file:disabled:text-gray-500 file:disabled:dark:bg-zinc-800",
    ],
    // focus
    focusInput,
    // invalid (optional)
