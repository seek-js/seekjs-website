  ...
  return (
    <div className="mt-36 flex flex-col overflow-hidden px-3">
      ...
      >
        ...
        <h1
          id="about-overview"
          className="mt-2 inline-block bg-linear-to-br from-zinc-950 to-zinc-800 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl dark:from-gray-50 dark:to-gray-300"
        >
          <Balancer>
      ...
      <section aria-labelledby="vision-title" className="mx-auto mt-40">
        ...
        <MetalPrimaryButton className="mt-32 w-full">
          View Open Roles
        </MetalPrimaryButton>
      </section>
    </div>
