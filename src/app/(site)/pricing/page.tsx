...
export default function Pricing() {
  ...
  return (
    <div className="px-3">
      ...
      >
        <Badge>Pricing</Badge>
        <h1 className="mt-2 inline-block bg-linear-to-br from-zinc-950 to-zinc-800 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl dark:from-gray-50 dark:to-gray-300">
          ...
          {plans.map((plan, planIdx) => (
            <div key={planIdx} className="mt-6">
              ...
              <div className="mx-auto max-w-md">
                <h2 className="mt-6 text-sm font-semibold text-zinc-950 dark:text-gray-50">
                  {plan.name}
                </h2>
                <div className="mt-3 flex items-center gap-x-3">
                  <span className="text-5xl font-semibold tabular-nums text-zinc-950 dark:text-gray-50">
                ...
                <div className="mt-6 flex flex-col justify-between">
                  ...
                  <div className="mt-6">
                    <MetalPrimaryButton asChild className="group">
      ...
      >
        <div className="mx-auto space-y-8 sm:max-w-md lg:hidden">
          {plans.map((plan) => (
            <div key={plan.name}>
              <div className="rounded-xl bg-gray-400/5 p-6 ring-1 ring-inset ring-gray-200 dark:ring-zinc-800">
                <h2
                  id={plan.name}
                  className="text-base font-semibold leading-6 text-zinc-950 dark:text-gray-50"
                >
                  {plan.name}
                </h2>
              ...
              <ul
                role="list"
                className="mt-10 space-y-10 text-sm leading-6 text-zinc-950 dark:text-gray-50"
              >
            ...
            <table className="w-full table-fixed border-separate border-spacing-0 text-left">
              ...
              <thead className="sticky top-28">
                <tr>
                  <th
                    scope="col"
                    className="border-b border-gray-100 bg-white pb-8 dark:border-gray-800 dark:bg-zinc-950"
                  >
                    <div className="font-semibold leading-7 text-zinc-950 dark:text-gray-50">
                      Compare prices
                    </div>
                  ...
                  {plans.map((plan) => (
                    <th
                      key={plan.name}
                      scope="col"
                      className="border-b border-gray-100 bg-white px-6 pb-8 lg:px-8 dark:border-gray-800 dark:bg-zinc-950"
                    >
                      <div
                        className={cx(
                          !plan.isStarter
                            ? "text-indigo-600 dark:text-indigo-400"
                            : "text-zinc-950 dark:text-gray-50",
              ...
              <tbody>
                  ...
                  <Fragment key={section.name}>
                    <tr>
                      <th
                        ...
                        className={cx(
                          ...
                          "border-b border-gray-100 pb-4 text-base font-semibold leading-6 text-zinc-950 dark:border-gray-800 dark:text-gray-50",
                        )}
                      >
                        {section.name}
                      </th>
                    ...
                    {section.features.map((feature) => (
                      ...
                      >
                        <th
                          scope="row"
                          className="flex items-center gap-2 border-b border-gray-100 py-4 text-sm font-normal leading-6 text-zinc-950 dark:border-gray-800 dark:text-gray-50"
                        >
                ...
                <tr>
                  <th
                    scope="row"
                    className="pt-6 text-sm font-normal leading-6 text-zinc-950 dark:text-gray-50"
                  >
